...
// Year Routes
router.post("/createYear", protect, restrictTo("admin"), createYear);
router.get("/years", getAllYears);
router.put("/years/:id", protect, restrictTo("admin"), updateYear);
router.delete("/years/:id", protect, restrictTo("admin"), deleteYear);

// Guest Routes
router.post("/addguests", protect, restrictTo("admin"), createGuest);
router.get("/allguests", getAllGuests);
router.get("/guests-yearwise", getGuestsGroupedByYear);
router.get("/guests/:id", getSingleGuest);
router.put("/guests/:id", protect, restrictTo("admin"), updateGuest);
